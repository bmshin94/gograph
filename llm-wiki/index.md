...
- [build-selection.md](build-selection.md) — Fingerprinted exclusions, safely masked tooling-directory symlinks, and CLI/MCP refresh boundaries.
...
- [mcp-registry.md](mcp-registry.md) — Registry identity, MCPB representation, release invariants, and preview limits.
...
- [GOGRAPH-HOMEBREW-POSTFLIGHT-1](claims/GOGRAPH-HOMEBREW-POSTFLIGHT-1.json) — Fail-closed structured Homebrew postflight publication with preserved quarantine handling.
...
- [security/flow-analysis.md](security/flow-analysis.md) — Security-flow sources, sinks, sanitizer policy, and analysis limits.
