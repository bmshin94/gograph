...
func TestHelpDocumentsEveryCanonicalCommand(t *testing.T) {
	...
	want := []string{
		"build", "stale", "stats", "explore", "query", "focus", "node", "source", "public",
